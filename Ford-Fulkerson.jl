...
# ╔═╡ 88bc87df-c8b0-483e-969b-fc5820a093ff
begin
	include("./Commom.jl")
	using .Commom
	using GraphPlot
...
# ╔═╡ d67afa62-a0d5-11ed-113b-072b7752da1d
md"""
# Ford Fulkerson
"""

# ╔═╡ f1154b1e-181f-4c18-a813-20aee3ffda4a
md"""
Fluxo Máximo
"""

# ╔═╡ cb198ede-e479-4ab8-a39e-411dfe54209a
const ∅ = []

# ╔═╡ 5b366980-cff3-4392-a643-a7fb4cd1079b
const ∞ = Inf

# ╔═╡ 79ad3b68-bde2-422e-a391-3a52b6322fb1
md"""
## Implementação
"""

# ╔═╡ d5a68682-38d6-446c-89e4-7d4c6bd40c7d
...
# ╔═╡ 756a1fce-0eaf-4f5b-88a1-c37d242ffda4
function fordfulkerson(G, s, t)
    ...
    while true
        ...
        while length(L) > 0 && t ∉ R
            ...
            Commom.imprimir(R, L, i, f⁺, f⁻, p, σ, y)
            if t ∈ R
...
# ╔═╡ 41d9d496-ab88-4a2a-83b7-95ae1ad9ee77
md"""
## Exemplo
"""

# ╔═╡ 8c28ef5b-0fde-40ab-9745-da7d712937ee
begin
	w = [
	     0  4  7  0 0  0
	     0  0  0  0 0  0
...
# ╔═╡ 38bb0e09-0605-4e4c-8d37-c3ef7bcd052f
fordfulkerson(w, 5, 2)
